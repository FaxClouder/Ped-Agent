...
from ped_video_analysis.vision.interface import VisionBackend
...
class VisionRegistry:
    ...
    def discover(cls) -> None:
        try:
            entry_points = importlib.metadata.entry_points(group="ped_video_analysis.vision")
        except Exception:
            return
...
def ensure_builtin_backends_registered() -> None:
    from ped_video_analysis.vision.plugins import yolo26_bytetrack, yolo26_deepsort  # noqa: F401
